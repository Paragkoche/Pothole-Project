...
ESP32_CAM_URL = "http://<ESP32_IP_ADDRESS>/stream"
app = FastAPI()
...
def gen_frames():
    ...
    try:
        ...
        if stream.status_code != 200:
            logging.error(
                f"Failed to connect to ESP32-CAM: {stream.status_code}")
            return
            ...
            if a != -1 and b != -1:
                ...
                for result in results:
                    ...
                    for box in boxes:
                        ...
                        if label == 'pothole' and conf > 0.5:  # Confidence threshold
        ...
        logging.error(f"Error with ESP32-CAM stream: {e}")
